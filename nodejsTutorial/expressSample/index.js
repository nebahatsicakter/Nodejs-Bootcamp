...
app.get("/api/products", function (req, res) {
  ...
  if (orderBy == null) {
    ...
    products = _.orderBy(productsData, ["name"], ["asc"]);
    res.json(products);
...
app.get("/api/products/:id", function (req, res) {
  //Gelen requestin parametresinden id
  var productId = req.params.id;
  //idye göre ürünü bulma
...
app.get("/api/products/category/:categoryId", function (req, res) {
  let categoryId = req.params.categoryId;
  let productsByCategoryId = productsData.filter(
    (q) => q.categoryId == categoryId
  );
  res.json(productsByCategoryId);
});

//yeni bir ürün ekleme, burada serverSide Validation yapıldı
app.post(
  "/api/products",
  body("name").notEmpty(),
  body("unitPrice")
    .notEmpty()
    .withMessage("UnitPrice alanı boş geçilemez")
    .isNumeric()
    .withMessage("UnitPrice numeric olmalıdır"),
  ...
  function (req, res) {
    ...
    var newProductId = productsData[productsData.length - 1].id + 1;
    var newProduct = {
      name: req.body.name,
    ...
    //yeni bir ürün eklemenin farklı bir yöntemi
    // var newProduct = new Object(F);
    // newProduct.name = req.body.name;
    // newProduct.unitPrice = req.body.unitPrice;
    // newProduct.unitsInStock = req.body.unitsInStock;
